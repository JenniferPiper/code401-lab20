...
exports.default = function (error, request, response, next) {
  ...
  if (errorMessage.includes('validation failed')) {
    _logger2.default.log(_logger2.default.INFO, 'ERROR MIDDLEWARE: Responding with a 400 code');
    return response.sendStatus(400);
  }
  if (errorMessage.includes('duplicate key')) {
    _logger2.default.log(_logger2.default.INFO, 'ERROR MIDDLEWARE: Responding with a 409 code');
